...
:: Version #
Set Version=1.1(An analogue of the first program)
...
curl -g -k -L -# -o "C:\NvidiaProfileInspector\ancel_nv_profile.nip" "https://github.com/ancel1x/Ancels-Performance-Batch/raw/refs/heads/main/bin/ancel_nv_profile.nip" >> APB_Log.txt
...
curl -g -k -L -# -o "C:\Ancels Power Plan.pow" "https://github.com/ancel1x/Ancels-Performance-Batch/raw/refs/heads/main/bin/Ancels_Power_Plan.pow" >> APB_Log.txt
...
:: Install DevManView
curl -g -k -L -# -o "C:\Windows\System32\DevManView.exe" "https://github.com/ancel1x/Ancels-Performance-Batch/raw/refs/heads/main/bin/DevManView.exe" >> APB_Log.txt
timeout /t 3 /nobreak > NUL
